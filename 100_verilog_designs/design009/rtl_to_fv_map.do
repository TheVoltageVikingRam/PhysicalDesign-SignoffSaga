...
# Generated on: Sun Sep 28 16:51:04 IST 2025 (Sun Sep 28 11:21:04 UTC 2025)
...
set logfile fv/demux/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/demux -revised fv_map -use_rtl_names
...
set env(CDN_SYNTH_ROOT) "/home/server2/cadence/installs/DDI231/GENUS231/tools.lnx86"
set CDN_SYNTH_ROOT      "/home/server2/cadence/installs/DDI231/GENUS231/tools.lnx86"
set env(CW_DIR) "/home/server2/cadence/installs/DDI231/GENUS231/tools.lnx86/lib/chipware"
set CW_DIR      "/home/server2/cadence/installs/DDI231/GENUS231/tools.lnx86/lib/chipware"
set lec_version_required "21.20249"
if { ($lec_version < $lec_version_required) &&
    [file exists /home/server2/cadence/installs/DDI231/GENUS231/tools.lnx86/lib/chipware/old_encrypt_sim]} {
    set env(CW_DIR_SIM) "/home/server2/cadence/installs/DDI231/GENUS231/tools.lnx86/lib/chipware/old_encrypt_sim"
    set CW_DIR_SIM      "/home/server2/cadence/installs/DDI231/GENUS231/tools.lnx86/lib/chipware/old_encrypt_sim"
} else {
    set env(CW_DIR_SIM) "/home/server2/cadence/installs/DDI231/GENUS231/tools.lnx86/lib/chipware/sim"
    set CW_DIR_SIM      "/home/server2/cadence/installs/DDI231/GENUS231/tools.lnx86/lib/chipware/sim"
}
...
add_search_path /home/server2/cadence/installs/DDI231/INNOVUS231/share/FoundationFlows/EXAMPLES/INNOVUS/DESIGN/GPDK/LIBS/GPDK045/timing -library -both
read_library -liberty -both \
    /home/server2/cadence/installs/DDI231/INNOVUS231/share/FoundationFlows/EXAMPLES/INNOVUS/DESIGN/GPDK/LIBS/GPDK045/timing/slow.lib \
    /home/server2/cadence/installs/DDI231/INNOVUS231/share/FoundationFlows/EXAMPLES/INNOVUS/DESIGN/GPDK/LIBS/GPDK045/timing/typical.lib \
    /home/server2/cadence/installs/DDI231/INNOVUS231/share/FoundationFlows/EXAMPLES/INNOVUS/DESIGN/GPDK/LIBS/GPDK045/timing/fast.lib
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k demux.v
elaborate_design -golden -root {demux} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/demux/fv_map.v.gz
elaborate_design -revised -root {demux}
...
set_analyze_option -mapping_file fv/demux/fv_map.map.do
...
set_system_mode lec
write_compared_points noneq.compared_points.demux.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.demux.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.demux.rtl.fv_map.rpt
