# *****************************************************
# * Script Name : Genus Legacy Mode Initialization
# *****************************************************
...
set LIB_PATH "${LOCAL_DIR}/work/reports"
set RTL_PATH "${LOCAL_DIR}/rtl"
set DESIGN "dtmf_recvr_core"
set DES $DESIGN 

set MSGS_TO_BE_SUPRESSED
...
suppress_messages {LBR-30 LBR-31 LBR-30 LBR-41 LBR-72 LBR-77 LBR-162}
