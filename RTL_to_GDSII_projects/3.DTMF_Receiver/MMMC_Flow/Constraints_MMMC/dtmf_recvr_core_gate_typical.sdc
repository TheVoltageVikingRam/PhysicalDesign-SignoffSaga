# ################################################################################
# Typical Corner Constraints for DTMF Receiver Core
# ################################################################################
...
create_clock -name "refclk" -add -period 6.0 -waveform {0.0 3.0} [get_ports refclk]
create_clock -name "m_clk" -add -period 6.0 -waveform {0.0 3.0} [get_pins TEST_CONTROL_INST/m_clk]
